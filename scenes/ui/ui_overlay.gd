...
const PROJECTS := {
	"workspace_hub": {
		"tagline": "Mission control for localhost.",
		"title": "workspace-hub",
	...
	"maverick": {
		"tagline": "Dashboard for the driveway.",
	...
	"momrecette": {
		"tagline": "Family recipes, kept forever.",
		"title": "MomRecette",
...
@onready var tagline_label: Label = $Root/InfoPanel/Margin/Column/TaglineLabel
...
func show_panel(anchor_id: String) -> void:
	...
	tagline_label.text = project.get("tagline", "")
	tagline_label.visible = tagline_label.text != ""
